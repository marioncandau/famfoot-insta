...
begin
  Result := inherited or ((Char = $203C) or (Char = $2049) or (Char = $2122) or
    (Char = $2139) or ((Char >= $2194) and (Char <= $2199)) or
    ((Char >= $21A9) and (Char <= $21AA)) or
    ((Char >= $231A) and (Char <= $231B)) or (Char = $2328) or (Char = $23CF) or
    ((Char >= $23E9) and (Char <= $23F3)) or
    ((Char >= $23F8) and (Char <= $23FA)) or (Char = $24C2) or
    ((Char >= $25AA) and (Char <= $25AB)) or (Char = $25B6) or (Char = $25C0) or
    ((Char >= $25FB) and (Char <= $25FE)) or
    ((Char >= $2600) and (Char <= $2604)) or (Char = $260E) or (Char = $2611) or
    ((Char >= $2614) and (Char <= $2615)) or (Char = $2618) or (Char = $261D) or
    (Char = $2620) or ((Char >= $2622) and (Char <= $2623)) or (Char = $2626) or
    (Char = $262A) or ((Char >= $262E) and (Char <= $262F)) or
    ((Char >= $2638) and (Char <= $263A)) or (Char = $2640) or (Char = $2642) or
    ((Char >= $2648) and (Char <= $2653)) or (Char = $2660) or (Char = $2663) or
    ((Char >= $2665) and (Char <= $2666)) or (Char = $2668) or (Char = $267B) or
    (Char = $267F) or ((Char >= $2692) and (Char <= $2697)) or (Char = $2699) or
    ...
    ((Char >= $26C4) and (Char <= $26C5)) or (Char = $26C8) or
    ((Char >= $26CE) and (Char <= $26CF)) or (Char = $26D1) or
    ((Char >= $26D3) and (Char <= $26D4)) or
    ((Char >= $26E9) and (Char <= $26EA)) or
    ((Char >= $26F0) and (Char <= $26F5)) or
    ((Char >= $26F7) and (Char <= $26FA)) or (Char = $26FD) or (Char = $2702) or
    (Char = $2705) or ((Char >= $2708) and (Char <= $270D)) or (Char = $270F) or
    (Char = $2712) or (Char = $2714) or (Char = $2716) or (Char = $271D) or
    (Char = $2721) or (Char = $2728) or ((Char >= $2733) and (Char <= $2734)) or
    (Char = $2744) or (Char = $2747) or (Char = $274C) or (Char = $274E) or
    ((Char >= $2753) and (Char <= $2755)) or (Char = $2757) or
    ((Char >= $2763) and (Char <= $2764)) or
    ((Char >= $2795) and (Char <= $2797)) or (Char = $27A1) or (Char = $27B0) or
    (Char = $27BF) or ((Char >= $2934) and (Char <= $2935)) or
    ((Char >= $2B05) and (Char <= $2B07)) or
    ((Char >= $2B1B) and (Char <= $2B1C)) or (Char = $2B50) or (Char = $2B55) or
    (Char = $3030) or (Char = $303D) or (Char = $3297) or (Char = $3299) or
    (Char = $1F004) or (Char = $1F0CF) or ((Char >= $1F170) and (Char <= $1F171)
    ) or ((Char >= $1F17E) and (Char <= $1F17F)) or (Char = $1F18E) or
    ((Char >= $1F191) and (Char <= $1F19A)) or
    ((Char >= $1F201) and (Char <= $1F202)) or (Char = $1F21A) or
    (Char = $1F22F) or ((Char >= $1F232) and (Char <= $1F23A)) or
    ...
    ((Char >= $1F573) and (Char <= $1F57A)) or (Char = $1F587) or
    ((Char >= $1F58A) and (Char <= $1F58D)) or (Char = $1F590) or
    ((Char >= $1F595) and (Char <= $1F596)) or
    ((Char >= $1F5A4) and (Char <= $1F5A5)) or (Char = $1F5A8) or
    ((Char >= $1F5B1) and (Char <= $1F5B2)) or (Char = $1F5BC) or
    ((Char >= $1F5C2) and (Char <= $1F5C4)) or
    ((Char >= $1F5D1) and (Char <= $1F5D3)) or
    ((Char >= $1F5DC) and (Char <= $1F5DE)) or (Char = $1F5E1) or
    (Char = $1F5E3) or (Char = $1F5E8) or (Char = $1F5EF) or (Char = $1F5F3) or
    ((Char >= $1F5FA) and (Char <= $1F64F)) or
    ((Char >= $1F680) and (Char <= $1F6C5)) or
    ((Char >= $1F6CB) and (Char <= $1F6D2)) or
    ((Char >= $1F6E0) and (Char <= $1F6E5)) or (Char = $1F6E9) or
    ((Char >= $1F6EB) and (Char <= $1F6EC)) or (Char = $1F6F0) or
    ...
    ((Char >= $1F980) and (Char <= $1F997)) or (Char = $1F9C0) or
